import img from '../../public/bolero.jpg';
    ...
    return (
        <div className={"mt-8"}>
            <div className="flex items-center justify-between">
                <h2 className={"text-white hover:text-fuchsia-600 cursor-pointer font-bold text-xl"}>Trữ Tình & Bolero</h2>
