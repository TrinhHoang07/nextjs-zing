import img from '../../public/songmovie.jpg';
    ...
    return (
        <div className={"mt-4"}>
            <div className="flex items-center justify-between">
                <h2 className={"text-white hover:text-fuchsia-600 cursor-pointer font-bold text-xl"}>Nhạc Phim</h2>
