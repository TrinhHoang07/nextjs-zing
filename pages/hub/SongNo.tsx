import img from '../../public/songno.jpg';
    ...
    return (
        <div className={"mt-4"}>
            <div className="flex items-center justify-between">
                <h2 className={"text-white hover:text-fuchsia-600 cursor-pointer font-bold text-xl"}>Nhạc Không Lời</h2>
