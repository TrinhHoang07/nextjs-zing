import img from '../../public/top100nt.jpg';
...
function OutandingTop100() {

    const [data] = useAxios('api/outstandingtop100');

    return (
        <div className={"mt-8"}>
            <h2 className={"text-white font-bold text-xl"}>Nổi Bật</h2>
...
export default OutandingTop100;