import img from '../../public/top100asian.jpg';
...
function Top100Asian() {

    const [data] = useAxios('api/top100asian');

    return (
        <div className={"mt-8"}>
            <h2 className={"text-white font-bold text-xl"}>Nhạc Châu Á</h2>
            <div className="flex mt-2 flex-wrap">
                {data?.general.map(info => (
                    <div key={info.id} className="w-1/4 px-2 mt-4">
                        <Link href={"#"}>
                            <a>
