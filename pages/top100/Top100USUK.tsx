import img from '../../public/top100usuk.jpg';
...
function Top100USUK() {
    ...
    const [data] = useAxios('api/top100USUK');

    return (
        <div className={"mt-8"}>
            <h2 className={"text-white font-bold text-xl"}>Nhạc Âu Mỹ</h2>
